...
class AppSettings(BaseSettings):
    ...
    def _validate_admin_password_length(self) -> AppSettings:
        ...
        An empty/missing env var means 'autogenerate on bootstrap' (ADR-0005),
        which is fine. A *set* value shorter than the floor is almost certainly
        an operator mistake we want to catch at boot rather than after the
        admin hash is committed to disk.
        """
