...
const messages = {
  ...
  hero: {
    ...
    startingBody: "OBS connected — spawning workers…",
    stoppingBody: "OBS disconnected — draining workers…",
    armedTitle: "Workers ready",
    armedBody: "Waiting for OBS to send the first frame.",
    liveSummary:
  ...
  dashboard: {
    ...
    emptyBody: "You haven't configured any targets yet. Add one and point OBS at the ingest URL.",
    emptyCta: "Open targets",
    disabledTitle: "Enable a target to get started",
    disabledBody:
      "You have configured targets, but none are enabled. Enable at least one before pointing OBS at the ingest URL.",
    ...
    vkPromptIntro:
      "VK requires a fresh stream key each broadcast. Paste it once now; the supervisor will pick it up the next time OBS publishes and wipe it when the session ends.",
    ...
    firstRunStep2: "Click Start streaming in OBS.",
    firstRunStep3: "Restream Plus auto-starts and fans out to your enabled targets.",
  },
  ...
  targetTab: {
    ...
    missingKeyBody:
      "This target is enabled but has no stream key. It will be skipped the next time OBS publishes until you add one below.",
